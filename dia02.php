        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col text-center">
                    <a href="dia01.php" class="btn btn-outline-light btn-lg w-25 me-3 ms-3 fw-bolder rounded-1">Dia 01</a>
                    <a href="dia02.php" class="btn btn-light btn-lg w-25 me-3 ms-3 fw-bolder rounded-1">Dia 02</a>
                ...
                while(!feof($arquivo)):
                    ...
                    <div class="col-md-4 col-sm-12 mb-3">
                        <div class="card" style="width: 18rem;">
                            <img src="img/<?php echo $dados[3] ?>" class="card-img-top imagem" alt="<?php echo $dados[0]?>">
                            <div class="card-body text-center">
                                <h5 class="card-title"><?php echo $dados[0] ?></h5>
                                <p class="card-text"><?php echo $dados[2] ?><br><?php echo $dados[1]?>
                                </p>
                            </div>
                        </div>
                    </div>
